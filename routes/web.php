...
Route::get('payy',function () {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        Route::get('update/your/data', [PlayController::class, 'updateYourData']);
        ...
        Route::prefix('users')->group(function () {
            ...
            Route::get('view/all', [UserController::class, 'usersJson'])->name('users.dataTables');
...
// Student ID Card Routes···
        ...
        Route::get('playing', [UserController::class, 'playing']);
    ...
    Route::get('create/multiple/posts', [PostController::class, 'createMultiplePosts']); // create 100 posts route
    ...
    Route::controller(TagController::class)->group(function () {
        Route::get('/create/multiple/tags', 'createMultipleTags');
    });
    ...
    Route::get('playy', [PlayController::class, 'playy']);
    Route::get('resource', [PlayController::class, 'resource']);
